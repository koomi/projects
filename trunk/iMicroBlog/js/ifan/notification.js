...
ifan.Notification.prototype = {
	...
	handleClick: function(){
		...
		$E.on(this.loader.window.document, 'mousedown', handler, this, true);
		function handler(e){
			var t = $E.getTarget(e);
			if (t.nodeName.toLowerCase() == 'img') t = t.parentNode;
			if (t.nodeName.toLowerCase() == 'a') ifan.util.openURLInBrowser(t.href);
			if (t.id == 'n-more') ifan.app.showWindow();
			this.hide();
		}
	}
}
